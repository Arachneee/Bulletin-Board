...
drop table if exists comment_empathy CASCADE;
create table comment_empathy
(
    comment_empathy_id bigint generated by default as identity,
    comment_id bigint not null,
    member_id bigint not null,
    foreign key (member_id) references member(member_id) on update cascade,
    foreign key (comment_id) references comment(comment_id) on update cascade,
    primary key (comment_empathy_id)
);